...
{	
	...
	public class ModelResourcesDesc
	{
		...
		{			
			...
			typeIdsInInsertOrder.Add(ModelCode.DCLINESEGM);
			typeIdsInInsertOrder.Add(ModelCode.ACLINESEGM);
		...
		{			
			...
			notSettablePropertyIds.Add(ModelCode.CONDEQIPMENT_TERMINAL);
			notSettablePropertyIds.Add(ModelCode.PERLENIMPENDANCE_ACLINESEGMS);
